...
you selected is in [the inspector](inspector/), and every insert is in
[the Insert view](context/insert.md). This is the decision that makes the
...
All of it is in [the Page view](context/page.md) and
[the Styles view](context/styles.md).
