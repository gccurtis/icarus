...
| --- | --- | --- |
| [Overview](context/overview.md) | The analysis itself, and running it | This analysis · Saved · Result · Attribution |
| [Variables](context/variables.md) | What can be charted, with fields expanded | Tables · Values · Functions |
| [Chart](context/chart.md) | What kind of picture to draw | The kinds |
| [Fields](context/fields.md) | Where each field has been put | X · Y · Filters · Sort · Limit |
| [Formula](context/formula.md) | What the builder compiled to | Compiled · Evaluation |
...
| --- | --- | --- |
| A field on an axis | One placement: the field, how it is summarised, what it is called | [placement.md](inspector/placement.md) |
| A variable in the Variables view | A table or value, its contents, and how it relates to others | [variable.md](inspector/variable.md) |
| The relationship warning | Two variables that need relating, and the fix | [relationship.md](inspector/relationship.md) |
| A filter | One rule about which rows are kept | [filter.md](inspector/filter.md) |
| The sort | What the result is ordered by | [sort.md](inspector/sort.md) |
| The limit | How much of the result is shown | [limit.md](inspector/limit.md) |
| The chart | Kind, title, axes, legend, colours | [chart.md](inspector/chart.md) |
| A bar, point or slice | One mark, and the rows underneath it | [mark.md](inspector/mark.md) |
| Nothing | The analysis itself | [analysis.md](inspector/analysis.md) |
