...
const GROUPS = [
  ...
  { key: "procedures", title: "The editor's procedures", match: (p) => p.startsWith("app/src/lib/app-views/categories/slide-deck-editor/procedures/") },
  { key: "content", title: "The content surface", match: (p) => p.startsWith("app/src/lib/app-views/categories/slide-deck-editor/content/") },
  { key: "context", title: "The context panels", match: (p) => p.startsWith("app/src/lib/app-views/categories/slide-deck-editor/context/") },
  { key: "inspector", title: "The inspector lenses and their shared sections", match: (p) => p.startsWith("app/src/lib/app-views/categories/slide-deck-editor/inspector/") || p.startsWith("app/src/lib/app-views/categories/slide-deck-editor/components/") },
