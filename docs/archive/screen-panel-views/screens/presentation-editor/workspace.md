# Presentation editor — the workspace
...
under the pointer — so a presentation survives a change of aspect ratio.
...
end of presentation) and **what it starts from** (a copy of this slide, blank, or one of
the presentation's layouts, each card naming its placeholder roles). Each placeholder
...
| | |
| --- | --- |
| Aspect ratio | 16:9 or 4:3, per presentation |
