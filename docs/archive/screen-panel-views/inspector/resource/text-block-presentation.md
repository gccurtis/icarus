...
**Needs** — the block's style reference into the presentation `StyleSet`, and its
alignment.
...
**Open** — "read when the slide is shown" needs defining. On presentation open, on slide
