...
| --- | --- | --- |
| A named style in the Theme view | Presentation typography, edited once for everywhere it is used | Identity · Typography · Usage |

The same principle as the document editor's styles, with one addition: a presentation
...
**Needs** — the typography fields on the presentation `StyleSet`.

**Open** — no line height. The document's equivalent has one; a presentation's does not,
