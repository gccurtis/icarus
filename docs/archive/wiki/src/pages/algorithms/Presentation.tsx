import presentationMd from "../../prose/algorithms/presentation.md?raw";
...
const Stage = () => (
  <Diagram viewBox="0 0 1180 300" caption="A frame is fractional; the stage converts at its boundary. The same frame draws correctly at any zoom and either aspect ratio.">
    ...
    <Box x={900} y={220} w={260} h={60} tone="active" title="runtime.apply(ops)" lines={["presentation-runtimes"]} mono />
...
export const Presentation = () => (
  <Page crumbs={[{ label: "Algorithms" }]} title="Presentation editor" lede="Konva as a projection: fractional frames, stage metrics in rem, pure procedures that return the next presentation and the ops that describe it.">
    <Sections markdown={presentationMd} after={{ "the-stage": <Stage /> }} />
  </Page>
);
