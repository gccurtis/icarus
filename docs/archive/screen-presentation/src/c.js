...
/* ============================================================
   The project the presentation is set in. Real content throughout —
...
const TABS = [
  ...
  { k: "presentation", label: "Board Update — October", icon: "presentation" },
...
SCREENS["project-overview"] = {
      ...
      <div class="split is-2-3">
        <div style="display:flex;flex-direction:column;gap:calc(var(--u)*2)">
          ...
          <div class="tbl-w">
            ...
            ${row("New presentation", { icon: "presentation", inspect: "project" })}
        ...
        ${table(
          ...
          [
            ...
            { inspect: "resource", cells: [
              { h: `<span class="cellname"><span class="row-i">${ic("presentation")}</span>Board Update — October</span>` },
              { h: "Presentation" }, { h: "2 hours ago", cls: "num" }, { h: who("Tomas Kaur", "actor") } ] },
            { inspect: "resource", cells: [
  ...
  contexts: () => [
    ...
    { id: "resources", label: "Resources", icon: "layers", body: () =>
      pane("Resources", [
        ...
        sec("Presentations", [row("Board Update — October", { icon: "presentation", inspect: "resource" }), row("Storm Hardening Options", { icon: "presentation", inspect: "resource" })].join(""), { count: 2, flush: true }),
    ...
    { id: "activity", label: "Activity", icon: "activity", body: () =>
      pane("Activity", [
        ...
        sec("Today", [
          ...
          row("<b>Tomas Kaur</b> created Board Update", { icon: "presentation", right: "5h", inspect: "activity" })
        ].join(""), { flush: true }),
    ...
    { id: "templates", label: "Templates", icon: "template", body: () =>
      pane("Templates", [
        ...
        sec("Presentations", row("Board update", { icon: "presentation", sub2: "Project · 2 variables", inspect: "resource" }), { count: 1, flush: true }),
  ...
  inspectors: {
    ...
    resource: { crumbs: [["Project", "project"], ["Q3 Resilience Memo", null]], body: [
      ...
      sec("Relationships", [row("Linked question · Why did Feeder 12 fail twice?", { icon: "flask" }), row("Cited by · Board Update — October", { icon: "presentation" })].join(""), { shut: true, flush: true }),
...
SCREENS["new-tab"] = {
    ...
    <div class="wrap">
      ...
      <div style="display:flex;flex-direction:column;gap:calc(var(--u)*3);align-items:center">
        <div class="chips" style="justify-content:center">
          ...
          ${mk("Presentation", "presentation", { inspect: "blank-presentation" })}
      ...
      <div style="display:flex;flex-direction:column;gap:calc(var(--u)*3)">
        ...
        <div class="carousel">
          ${[["Q3 Resilience Memo", "Document · 4m", "doc"], ["Board Update — October", "Presentation · 2h", "presentation"], ["Outage Cost Model", "Spreadsheet · 1d", "sheet"], ["Interconnect Failure Review", "Document · 2d", "doc"], ["Substation Inventory", "Spreadsheet · 4d", "sheet"], ["Storm Hardening Options", "Presentation · 1w", "presentation"]]
      ...
      <div style="display:flex;flex-direction:column;gap:calc(var(--u)*3)">
        ...
        <div class="carousel">
          ${[["Regulatory filing shell", "Document · 4 variables", "doc"], ["Incident review", "Document · Global", "doc"], ["Board update", "Presentation · 2 variables", "presentation"], ["Cost model skeleton", "Spreadsheet", "sheet"], ["Storm brief", "Document · 3 variables", "doc"], ["Weekly ops presentation", "Presentation", "presentation"]]
  ...
  contexts: () => [
    { id: "create", label: "Create", icon: "plus", body: () =>
      pane("Create", [
        sec("Editors", [row("Document", { icon: "doc", inspect: "blank-doc", on: true }), row("Presentation", { icon: "presentation", inspect: "blank-presentation" }), row("Spreadsheet", { icon: "sheet", inspect: "blank-sheet" })].join(""), { flush: true }),
    ...
    { id: "recent", label: "Recent", icon: "clock", body: () =>
      pane("Recent", [
        sec("Today", [row("Q3 Resilience Memo", { icon: "doc", right: "4m", inspect: "recent", on: true }), row("Board Update — October", { icon: "presentation", right: "2h", inspect: "recent" })].join(""), { flush: true }),
    ...
    { id: "templates", label: "Templates", icon: "template", body: () =>
      pane("Templates", [
        ...
        sec("Presentation", [row("Board update", { icon: "presentation", sub2: "Project · 2 variables", inspect: "template" }), row("Weekly ops presentation", { icon: "presentation", sub2: "Project", inspect: "template" })].join(""), { count: 2, flush: true }),
  ...
  inspectors: {
    ...
    "blank-presentation": { crumbs: [["New tab", null], ["Presentation", null]], body: [
      sec("Identity", `<div class="fld"><span class="fld-k">Title</span><span class="fld-v"><span class="inp is-filled">Untitled presentation</span></span></div>`),
      ...
      sec("Create", `<div class="btn-row">${btn("Create presentation", { k: "pri", big: true })}</div>`)
    ].join("") },
