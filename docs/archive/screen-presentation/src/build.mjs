/**
 * Assembles the screen presentation into one self-contained page.
 *
 ...
 *   node build.mjs        # writes ../icarus-screen-presentation.html
 *
...
if (preview) {
  ...
  fs.writeFileSync("../icarus-screen-presentation.html", body);
  console.log("../icarus-screen-presentation.html");
}
