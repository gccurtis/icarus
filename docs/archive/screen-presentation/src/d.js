...
SCREENS["presentation"] = {
  ...
  path: "docs/screen-specs/presentation-editor.md",
  purpose:
    "One slide on a canvas, the presentation in the panel, and every property of what you selected in the inspector. Shift-click to multi-select; arrange, align and format are inspector work, not a toolbar.",
  init: { ctx: "presentation", inspect: "element", mode: "slide" },
  zoomable: true,
  pasteboard: true,
  ...
  contexts: (s) => s.mode === "layout" ? [
    { id: "layouts-l", label: "Layouts", icon: "template", body: () =>
      pane("Layouts", sec("In this presentation", [
    ...
    { id: "theme-l", label: "Theme", icon: "pal", body: () =>
      pane("Theme", sec("Background", kv([["Kind", "Solid"], ["Colour", "Paper"]]) + note("A layout inherits the presentation theme unless it overrides it."))) },
    { id: "variables", label: "Variables", icon: "hash", body: VARIABLES }
  ] : [
    { id: "presentation", label: "Slides", icon: "presentation", body: () =>
      pane("Slides", [
    ...
    { id: "overview", label: "Overview", icon: "info", body: () =>
      pane("Overview", [
        sec("This presentation", `<div class="fld"><span class="fld-k">Title</span><span class="fld-v"><span class="inp is-filled">Board Update — October</span></span></div>` + kv([["Slides", "8", { mono: true }], ["Aspect ratio", `<span class="chips">${chip("16:9", "act")}${chip("4:3")}</span>`]])),
    ...
    { id: "find", label: "Find", icon: "search", body: () =>
      ...
      ].join(""), { count: 3, flush: true }), { search: search("Search presentation", "relay") }) },
    ...
    { id: "layouts", label: "Layouts", icon: "template", body: () =>
      pane("Layouts", [
        ...
        sec("Presentation layouts", [layoutCard("Title slide", "1 placeholder · 2 locked"), layoutCard("Section break", "1 placeholder · 1 locked"), layoutCard("Full-bleed chart", "1 placeholder · 2 locked"), layoutCard("Blank", "no placeholders")].join(""), { count: 4, flush: true })
    ...
    { id: "theme", label: "Theme", icon: "pal", body: () =>
      pane("Theme", [
        ...
        sec("Named styles", [row("Slide title", { icon: "type", sub2: "24/32 · 600", inspect: "named-style-presentation" }), row("Body", { icon: "type", sub2: "13/20 · 400", inspect: "named-style-presentation" }), row("Caption", { icon: "type", sub2: "10/14 · mono", inspect: "named-style-presentation" })].join(""), { count: 3, flush: true, shut: true })
      ].join("")) },
    ...
    { id: "notes", label: "Notes", icon: "quote", body: () =>
      pane("Notes", [
        ...
        sec("Presentation", [row("1 · Board Update — October", { sub2: "No notes" }), row("2 · Where we stand", { sub2: "Two paragraphs" }), row("3 · Three storm events", { sub2: "One paragraph" }), row("4 · Feeder 12 in detail", { sub2: "One paragraph", on: true })].join(""), { flush: true })
      ].join("")) },
    ...
    { id: "comments", label: "Comments", icon: "comment", body: () =>
      pane("Comments", [
        `<div class="chips" style="padding:0 calc(var(--u)*3) calc(var(--u)*2)">${chip("Presentation")}${chip("Slide 4", "act")}${chip("Element")}</div>`,
        sec("Open", row("Tomas Kaur", { icon: "at", sub2: "“@ana is this the chart you wanted…”", right: "4h", inspect: "comment-presentation", on: true }), { count: 1, flush: true }),
  ...
  inspectors: {
    element: { crumbs: [["Presentation", "presentation"], ["Slide 4", "slide"], ["Element", null]], body: [
    ...
    "multi-element": { crumbs: [["Presentation", "presentation"], ["Slide 4", "slide"], ["3 elements", null]], body: [
    ...
    "nested-block": { crumbs: [["Presentation", "presentation"], ["Slide 4", "slide"], ["Element", "element"], ["Text block", null]], body: [
    ...
    layout: { crumbs: [["Presentation", "presentation"], ["Layout", null]], body: [
    ...
    "locked-element": { crumbs: [["Presentation", "presentation"], ["Layout", null], ["Locked element", null]], body: [
    ...
    slide: { crumbs: [["Presentation", "presentation"], ["Slide 4", null]], body: [
      sec("Speaker notes", `<div class="quote-v">Lead with the relay finding, not the spend. If asked about the 2024 precedent, the docket number is in the appendix.</div>` + note("Notes belong to the slide, not to the canvas. The Notes panel shows them for the whole presentation.")),
    ...
    presentation: { crumbs: [["Presentation", null]], body: [
      sec("This presentation", `<div class="fld"><span class="fld-k">Title</span><span class="fld-v"><span class="inp is-filled">Board Update — October</span></span></div>` + kv([["Slides", "8", { mono: true }], ["Aspect ratio", chip("16:9", "off")], ["Saved", chip("All changes saved", "ok")]])),
    ...
    theme: { crumbs: [["Presentation", "presentation"], ["Theme", null]], body: [
    ...
    "notes-block": { crumbs: [["Presentation", "presentation"], ["Slide 4", "slide"], ["Notes", null]], body: [
    ...
    "named-style-presentation": { crumbs: [["Presentation", "presentation"], ["Styles", null], ["Slide title", null]], body: [
    ...
    "comment-presentation": { crumbs: [["Presentation", "presentation"], ["Slide 4", "slide"], ["Comment", null]], body: [
    ...
    placeholder: { crumbs: [["Presentation", "presentation"], ["Layout", null], ["Placeholder", null]], body: [
  ...
  notes: {
    ...
    nav: ["Layers owns the visible object list and the accessibility fallback. Find owns presentation-wide search.", "Duplicating a slide mints new IDs for the slide and every identified descendant.", "Entering Layout mode commits or cancels the nested block edit and starts a distinct undo group."],
    revised: ["The presentation header and the toolbar are gone. New, Duplicate, Delete and Hide sit at the top of the Slides panel, where the slide they act on already is.", "Arrange, align and distribute are inspector sections. Select one element for arrange; shift-click for align and distribute.", "Aspect ratio and template origin moved to the Overview panel — neither changes while you work, so neither earned permanent width."],
