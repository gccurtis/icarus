...
/* ============================================================
   New Slide — a chooser owned by a presentation tab, never a tab.
   ============================================================ */
const NEW_SLIDE = () => `
  <div class="ovl">
    <div class="ovl-p">
      ...
      <div class="ovl-b">
        <div style="display:flex;flex-direction:column;gap:calc(var(--u)*2)">
          ...
          <div class="chips">
            ${chip("After this slide", "act")}${chip("Before this slide")}${chip("End of “The case”")}${chip("End of presentation")}
          </div>
        </div>
        <div style="display:flex;flex-direction:column;gap:calc(var(--u)*2)">
          ...
          <div class="cards" style="grid-template-columns:repeat(auto-fill,minmax(150px,1fr))">
            ...
            ${card("Blank", "Presentation theme, nothing on it", { icon: "presentation" })}
          </div>
        </div>
        <div style="display:flex;flex-direction:column;gap:calc(var(--u)*2)">
...
const SLIDES = [
  ...
  { s: "presentation", label: "5 · Presentation editor", st: { ctx: "presentation", inspect: "element" } },
  { s: "presentation", label: "6 · Slides — multi-select", st: { ctx: "layers", inspect: "multi-element" } },
  { s: "presentation", label: "7 · New Slide chooser", st: { mode: "slide", overlay: true, inspect: "placeholder" } },
  { s: "presentation", label: "8 · Presentation — editing a layout", st: { mode: "layout", ctx: "layouts-l", inspect: "layout" } },
...
/**
 * The presentation's own aids. Everything a screen can show is enumerated here so a
