 ...
 *
 * Offered beside the interface rather than written into each consumer because
 * "required string" is the shape almost every key has, and eight hand-written
 * copies of the same check drift. A key with a richer shape validates itself
 * where it is read.
 */
