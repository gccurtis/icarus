...
/**
 * The one observability owner for one process. Created at startup, closed at
 * shutdown, and the only thing that may close what it opened.
 */
...
/**
 * A log stream this object opened and must therefore close.
 *
