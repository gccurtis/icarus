...
| Production composition | [`create/knowledge.ts`](../../../initialization/runtimes/knowledge.ts), [`create-runtime.ts`](../../../initialization/create-runtime.ts) |
| Scope/resource adapter | [`create/resource-reader.ts`](../../../initialization/runtimes/resource-reader.ts) |
