...
[`createInvestigationRuntimeInstance`](../../../initialization/runtimes/investigation.ts)
...
The relevant order in [`startBackend`](../../../initialization/create-runtime.ts) is:
...
[`ResourceRegistry`](../../../initialization/runtimes/resource-reader.ts) accepts the
