...
import type { Embedder } from "#capabilities/knowledge/embedder.js";
import type { ToolBinding } from "#capabilities/intelligence/tools.js";
import type { Logger } from "#capabilities/observability/logger.js";
import { windowText, StreamWindower, DEFAULT_WINDOW_OPTIONS } from "#capabilities/knowledge/windowing/index.js";
import {
  buildCorpusTier,
  buildSourceLattice,
  ...
  makeWindowId,
  type Artifact
} from "#capabilities/knowledge/lattice/cluster.js";
import { descent, DEFAULT_BEAM, DEFAULT_THRESHOLD } from "#capabilities/knowledge/lattice/descent.js";
import { assembleRegions, DEFAULT_CHAR_BUDGET } from "#capabilities/knowledge/lattice/regions.js";
import { repairCorpus } from "#capabilities/knowledge/lattice/repair.js";
