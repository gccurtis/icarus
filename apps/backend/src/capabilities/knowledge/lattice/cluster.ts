...
import type { KnowledgeNode, FrontierEntry, ClusterConfig, KNNConfig } from "#capabilities/knowledge/types.js";
import { NODE_PREFIX, WINDOW_PREFIX, isWindowId } from "#capabilities/knowledge/types.js";
import {
  ...
  minPairwiseSim,
  normalize
} from "#capabilities/knowledge/lattice/math.js";
import { buildKNNGraph, projectVector } from "#capabilities/knowledge/lattice/knn.js";
