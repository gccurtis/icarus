...
import type { Configuration } from "#configuration/runtime-objects/configuration/definition.js";
import { SnapshotConfiguration } from "#configuration/runtime-objects/configuration/definition.js";

const configurationDirectory: string = dirname(
  fileURLToPath(import.meta.resolve(`#config-files/${"server.yaml"}`))
);
