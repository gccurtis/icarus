...
import { canonicalType } from "#data-manager/runtime-api/define/canonical-type.js";
import { canonicalValue } from "#data-manager/runtime-api/define/canonical-value.js";
import {
  invalidValue,
  isRecord
...
import type { TableType } from "#data-manager/types/schema.js";
import type {
  NamedVariable,
  NamedVariableInput
