# Data Manager Runtime API

One directory per public method on `DataManager`, named after the method in
...
anywhere. `InMemoryDataManager` is the only thing that holds a catalog, and these
