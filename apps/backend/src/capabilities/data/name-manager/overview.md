...
binding stay outside Name Manager.
...
| --- | ---- | ----- | ----------- | -------- |
| `define` | runtime method | `NameManager` | Adds one validated declaration to the catalog. | [define.md](runtime-api/define/define.md) |
| `get` | runtime method | `NameManager` | Retrieves a declaration when the name exists. | [get.md](runtime-api/get/get.md) |
| `require` | runtime method | `NameManager` | Retrieves a declaration or fails. | [require.md](runtime-api/require/require.md) |
| `list` | runtime method | `NameManager` | Returns every current declaration. | [list.md](runtime-api/list/list.md) |
...
Every expected failure is a `NameManagerError` from
