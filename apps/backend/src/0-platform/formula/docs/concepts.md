...
- Structured Data owns declarations and rows. [`FormulaNameResolver`](../../../1-init/create/formula-name-resolver.ts) is an initialization adapter that reads exactly the Structured Data instance injected into it.
