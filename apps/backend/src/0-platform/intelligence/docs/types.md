...
The equivalent backend configuration interfaces and parsing logic live in [`loadBackendConfig.ts`](../../../0-utils/config/loadBackendConfig.ts). They are structurally compatible rather than imported from this package.
