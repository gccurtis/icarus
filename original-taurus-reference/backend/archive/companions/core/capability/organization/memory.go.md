...
In-memory organization Store for focused tests: orgs by id, memberships keyed by org+user. Semantics match the SQLite store. See repo conventions (AGENTS.md).
