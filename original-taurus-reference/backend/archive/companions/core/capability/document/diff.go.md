...
Structural diff engine: compares two document revision heads at the row, block,
atom, and mark level using stable IDs. Reports added, removed, moved, and
content-changed items with bounded output.
