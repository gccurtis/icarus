...
Document duplication: deep-copies a Base while regenerating every internal ID
and remapping all cross-references between rows, blocks, atoms, marks, style
definitions, and style references.
