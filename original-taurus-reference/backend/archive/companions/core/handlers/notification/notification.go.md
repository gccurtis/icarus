...
The caller's toast-drain endpoint: GET /notifications drains and clears the signed-in user's pending toasts for the selected Project, serializing each toast to JSON. Destructive by contract. See repo conventions (AGENTS.md).
