---
title: "Α-057 — Connectors, Library & External File-Picker Flows"
notion_page_id: "3adb6410e502815fb293d572197c3466"
notion_url: "https://app.notion.com/3adb6410e502815fb293d572197c3466"
...
# Α-057 — Connectors, Library & External File-Picker Flows

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 6 — AI, ingestion and interchange
> **Outcome:** Implement connector discovery, connect/permission states, resource browsing, source refresh, disconnect, external picker, User Library insertion, and Project copy/materialization semantics.
## Why this packet exists
Implement connector discovery, connect/permission states, resource browsing, source refresh, disconnect, external picker, User Library insertion, and Project copy/materialization semantics. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- transfer helpers and absent provider flows
- fixture libraries
- shell import/connect entry points
...
- Consume typed connector/source lifecycle endpoints rather than constructing provider URLs ad hoc.
- Separate user-level connections and library records from Project-owned materialized resources.
- Provide accessible large-source browsing/search and exact permission explanations.
- Test redirect cancellation, revoked credentials, stale cursors, duplicate materialization, and cross-Project isolation.
### Specific completion gate
Connector credentials never enter frontend bundle, memory beyond provider redirects, telemetry, or logs; denied/revoked/expired connections and source refresh failures recover predictably.
...
- Ω-033: <mention-page url="https://app.notion.com/p/3adb6410e502816cb7bbf4e1e525db68"/>
