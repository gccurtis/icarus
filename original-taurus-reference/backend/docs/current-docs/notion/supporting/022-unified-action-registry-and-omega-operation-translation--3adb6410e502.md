---
title: "Α-022 — Unified Action Registry & Omega Operation Translation"
notion_page_id: "3adb6410e5028179b214e38d89b8397a"
notion_url: "https://app.notion.com/3adb6410e5028179b214e38d89b8397a"
...
# Α-022 — Unified Action Registry & Omega Operation Translation

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 2 — User Cell and Project Subcell runtime
> **Outcome:** Give each user-visible action a stable ID, availability rule, typed payload/result, one controller implementation, and explicit translation into navigation, Workspace commands, capability operations, or transactions.
## Why this packet exists
Give each user-visible action a stable ID, availability rule, typed payload/result, one controller implementation, and explicit translation into navigation, Workspace commands, capability operations, or transactions. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- Document action table
- AI agent actions
- Slides global store functions and feature callbacks
...
- Separate presentation metadata from execution ports.
- Report authoritative unavailability/refusal reasons and recheck before submission.
- Model multi-target operations with per-target aggregate/revision preconditions.
- Record focus/announcement origin without changing domain meaning.
### Specific completion gate
Toolbar, menu, shortcut, command palette, Inspector, Context, and approved AI application invoke the same action implementation and domain semantics.
