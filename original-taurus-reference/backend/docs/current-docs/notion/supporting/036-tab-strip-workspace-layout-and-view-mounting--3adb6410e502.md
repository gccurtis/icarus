---
title: "Α-036 — Tab Strip, Workspace Layout & View Mounting"
notion_page_id: "3adb6410e5028159a309e6a822b933aa"
notion_url: "https://app.notion.com/3adb6410e5028159a309e6a822b933aa"
...
# Α-036 — Tab Strip, Workspace Layout & View Mounting

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 4 — Project workspace and panels
> **Outcome:** Implement permanent system tabs, resource/launcher entries, stable-ID reorder, close/reopen, active routing, view mounts, suspension, and pending indicators against revisioned Workspace state.
## Why this packet exists
Implement permanent system tabs, resource/launcher entries, stable-ID reorder, close/reopen, active routing, view mounts, suspension, and pending indicators against revisioned Workspace state. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- `TabStrip and data/workspace.ts`
- hard-coded WorkSurface stage switch
- resource runtime registry used only by Document
...
- Use stable move anchors and undoable Workspace commands rather than index mutation.
- Separate resource replica lease from mounted editor/view lease.
- Suspend heavy rendering without suspending synchronization/pending work.
- Test two views of one resource, two Projects, and stale-tab target recovery.
### Specific completion gate
Rapid switching and repeated mount/unmount produce no lost operations, duplicate engines, stale subscriptions, or listener leaks; system tabs remain non-closeable and launcher resolves in place.
