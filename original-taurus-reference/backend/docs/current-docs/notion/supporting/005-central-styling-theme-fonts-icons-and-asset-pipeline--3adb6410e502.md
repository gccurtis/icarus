---
title: "Α-005 — Central Styling, Theme, Fonts, Icons & Asset Pipeline"
notion_page_id: "3adb6410e5028100b19ec124ac610204"
notion_url: "https://app.notion.com/3adb6410e5028100b19ec124ac610204"
...
# Α-005 — Central Styling, Theme, Fonts, Icons & Asset Pipeline

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 1 — Component and visual substrate
> **Outcome:** Connect existing visual authorities to one semantic token, theme, font, icon, motion, and asset entry point without duplicating the styling documents.
## Why this packet exists
Connect existing visual authorities to one semantic token, theme, font, icon, motion, and asset entry point without duplicating the styling documents. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- `src/app.css and docs/style authorities`
- IBM Plex and icon package setup
- hard-coded editor and Slides rendering colors
...
- Define semantic/component/resource token APIs and SSR-safe theme initialization.
- Centralize shell and panel geometry, including Context and Inspector bounds.
- Create icon naming, accessible-label, and decorative-icon rules.
- Add asset optimization, reduced-motion, forced-color, and theme-mirror checks.
### Specific completion gate
A governed style change has one central implementation path; migrated components contain no unmanaged product colors, geometry constants, icon loading, font loading, or motion values.
