---
title: "Α-066 — Production Build, Deployment Configuration & Observability"
notion_page_id: "3adb6410e50281a188ffed128568eee0"
notion_url: "https://app.notion.com/3adb6410e50281a188ffed128568eee0"
...
# Α-066 — Production Build, Deployment Configuration & Observability

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 7 — Security, quality and production certification
> **Outcome:** Make Alpha deployable with an explicit SvelteKit adapter, validated runtime configuration, Omega/control-plane origins, security headers, cache/version strategy, release identity, safe telemetry/error capture, health smoke tests, and rollback.
## Why this packet exists
Make Alpha deployable with an explicit SvelteKit adapter, validated runtime configuration, Omega/control-plane origins, security headers, cache/version strategy, release identity, safe telemetry/error capture, health smoke tests, and rollback. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- adapter-auto and development stack scripts
- Vite production build
- no settled production telemetry/cache/version contract
...
- Select and document the deployment adapter/topology without coupling domain code to hosting.
- Validate required environment at startup and expose safe release/config identity.
- Configure CSP and cache invalidation/version mismatch behavior.
- Provide health/readiness smoke, observability redaction, rollback, and compatibility instructions.
### Specific completion gate
A clean production environment builds, deploys, starts, authenticates, connects to Omega, reports health/version, survives rolling upgrade, and never bundles secrets, development adapters, or mock gateways.
...
- <mention-page url="https://app.notion.com/p/3acb6410e502816585d9e96ff02921d8"/>
