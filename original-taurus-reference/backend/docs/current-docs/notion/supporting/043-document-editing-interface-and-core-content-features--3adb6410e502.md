---
title: "Α-043 — Document Editing Interface & Core Content Features"
notion_page_id: "3adb6410e50281f193ced1daebcfcf76"
notion_url: "https://app.notion.com/3adb6410e50281f193ced1daebcfcf76"
...
# Α-043 — Document Editing Interface & Core Content Features

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 5 — Editors and resource views
> **Outcome:** Decompose and complete the existing Document interface—Document bar, ProseMirror host/paper, gutter/presence, content editing, toolbar, and accessibility—while preserving proven HTML and behavior.
## Why this packet exists
Decompose and complete the existing Document interface—Document bar, ProseMirror host/paper, gutter/presence, content editing, toolbar, and accessibility—while preserving proven HTML and behavior. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- `609-line DocumentStage.svelte`
- custom schema/bridge and editor CSS
- view-level timers, rename/export/presence/layout intermingling
...
- Support governed blocks, atoms, marks, headings, lists, tables, code, links, media, prompt blocks, paste, and drag/drop.
- Extract view lifecycle, chrome, paper/frame, gutter, and presence controllers.
- Use one action table for toolbar, menu, shortcut, Inspector, and AI application.
- Keep PDF/DOCX export and document row-windowing outside scope unless their authorities change.
### Specific completion gate
Every supported Omega Document mutation is reachable through keyboard or accessible controls and round-trips exactly; the stage only acquires runtime, attaches the view, and composes focused components.
