---
title: "Α-015 — Explicit Project Admission & Scope Establishment"
notion_page_id: "3adb6410e5028111a985fec23dc8df19"
notion_url: "https://app.notion.com/3adb6410e5028111a985fec23dc8df19"
...
# Α-015 — Explicit Project Admission & Scope Establishment

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 2 — User Cell and Project Subcell runtime
> **Outcome:** Replace ambient selected-Project behavior with fresh admission and explicit Project identity on every Project request.
## Why this packet exists
Replace ambient selected-Project behavior with fresh admission and explicit Project identity on every Project request. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- POST /session/project in /projects/\[id\]
- withProject retry retargeting
- projectless /workspace requests
...
- Define ProjectScope and typed admission results.
- Require ProjectID at every Project gateway boundary.
- Separate navigation preference from authorization/admission.
- Add simultaneous-two-Project browser sabotage tests and delete ambient retargeting compatibility after parity.
### Specific completion gate
Two browser tabs may use different Projects without retargeting one another; no Project request, including Workspace, catalog, activity, resource, editor, AI, job, or transfer calls, depends on mutable session selection.
