---
title: "Α-067 — Full Product Demonstration, Legacy Removal & Final Certification"
notion_page_id: "3adb6410e502813e8007ef9c301357ff"
notion_url: "https://app.notion.com/3adb6410e502813e8007ef9c301357ff"
...
# Α-067 — Full Product Demonstration, Legacy Removal & Final Certification

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 7 — Security, quality and production certification
> **Outcome:** Run the canonical signed-in product demonstration through control-plane surfaces, Project admission, Workspace, all editors/viewers, AI, ingestion, connectors, import/export, collaboration, settings/admin, convergence, and recovery—then remove every superseded path.
## Why this packet exists
Run the canonical signed-in product demonstration through control-plane surfaces, Project admission, Workspace, all editors/viewers, AI, ingestion, connectors, import/export, collaboration, settings/admin, convergence, and recovery—then remove every superseded path. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- full current Alpha demo and real Omega harness
- fixture libraries and local Slides store
- legacy Workspace/direct-load/global-panel paths
...
- Demonstrate sign-in, Project selection, Overview, Project Agents, resource lifecycle, Document, Slides, one-grid Spreadsheet, Chat, viewers, Quarterback, ingestion, connector, transfer, settings, and Organization admin.
- Exercise denial, revocation, conflict, offline/reconnect, failed job, and recovery paths.
- Delete feature flags/mocks/shims only after parity evidence and update companion docs.
- Publish final test outputs, screenshots, traces, deployment identity, residual deferrals, and release sign-off.
### Specific completion gate
Every completion-census row has passing evidence or an explicit governed deferral; no invisible mock, generic placeholder, direct transport path, ambient Project scope, stale store, dead component/CSS, or compatibility shim remains.
...
- Ω-001 (see <mention-page url="https://app.notion.com/p/3adb6410e50281e286aff541de343991"/>)
