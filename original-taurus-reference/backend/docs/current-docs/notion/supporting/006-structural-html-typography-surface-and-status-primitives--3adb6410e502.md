---
title: "Α-006 — Structural HTML, Typography, Surface & Status Primitives"
notion_page_id: "3adb6410e50281dd8ccff24512ba807c"
notion_url: "https://app.notion.com/3adb6410e50281dd8ccff24512ba807c"
...
# Α-006 — Structural HTML, Typography, Surface & Status Primitives

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 1 — Component and visual substrate
> **Outcome:** Implement semantic document regions and the smallest reusable visual primitives for typography, surfaces, dividers, scroll regions, badges, progress, skeleton, loading, empty, error, and visually hidden states.
## Why this packet exists
Implement semantic document regions and the smallest reusable visual primitives for typography, surfaces, dividers, scroll regions, badges, progress, skeleton, loading, empty, error, and visually hidden states. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- current atom/data/feedback exports
- feature-local loading and empty markup
- `/components live gallery`
...
- Prefer native landmarks and headings over role emulation.
- Expose state and announcements without binding to a feature runtime.
- Support composition without arbitrary raw HTML escape hatches.
- Retire duplicate feature-local status patterns as consumers migrate.
### Specific completion gate
Every primitive has semantic HTML, all product states, centralized styling, catalog examples, DOM tests, zoom/reflow behavior, forced-color behavior, and screenshot baselines.
