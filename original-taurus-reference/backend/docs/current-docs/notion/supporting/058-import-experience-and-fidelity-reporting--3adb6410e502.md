---
title: "Α-058 — Import Experience & Fidelity Reporting"
notion_page_id: "3adb6410e50281169c35fc3232c0ccf9"
notion_url: "https://app.notion.com/3adb6410e50281169c35fc3232c0ccf9"
...
# Α-058 — Import Experience & Fidelity Reporting

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 6 — AI, ingestion and interchange
> **Outcome:** Implement supported Document, Slides, one-grid Spreadsheet, PDF, image, CSV, and XLSX import jobs with options, progress, warnings, partial-fidelity reporting, result artifacts, and open/reveal behavior.
## Why this packet exists
Implement supported Document, Slides, one-grid Spreadsheet, PDF, image, CSV, and XLSX import jobs with options, progress, warnings, partial-fidelity reporting, result artifacts, and open/reveal behavior. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- ImportDialog and transfer matrix
- Markdown-oriented Document IO
- no production Spreadsheet/Slides conversion UI
...
- Drive format/options from backend capabilities and validate original bytes.
- Show conversion receipt, warnings, unsupported elements, and source linkage before claiming completion.
- Open the created canonical resource only after durable creation.
- Reject/defer legacy XLS, audio, and unsupported formats explicitly.
### Specific completion gate
The UI never promises unsupported fidelity; partial conversion, unsupported constructs, cancellation, retry, duplicate submission, and conversion failure are visible and recoverable.
