---
title: "Α-048 — One-Grid Spreadsheet Adapter, Rendering & Virtualization"
notion_page_id: "3adb6410e502817ba915c7bb3db6bc0e"
notion_url: "https://app.notion.com/3adb6410e502817ba915c7bb3db6bc0e"
...
# Α-048 — One-Grid Spreadsheet Adapter, Rendering & Virtualization

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 5 — Editors and resource views
> **Outcome:** Freeze the one-resource/one-sparse-grid contract, select a free open-source grid/rendering strategy through an adapter, and implement bounded rendering over stable RowID, ColumnID, CellID, and RangeRef identity.
## Why this packet exists
Freeze the one-resource/one-sparse-grid contract, select a free open-source grid/rendering strategy through an adapter, and implement bounded rendering over stable RowID, ColumnID, CellID, and RangeRef identity. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- no Spreadsheet stage/runtime/client/grid dependency
- resource kind/create affordance and generic placeholder
- one-grid Yesod authority
...
- Model SpreadsheetID and stable row/column/cell/range references; treat A1 as revision-bound projection.
- Evaluate only permissively licensed dependencies and keep the adapter replaceable.
- Implement row/column headers, viewport, dimensions, range selection, and ARIA grid/proxy strategy.
- Fence stale grid events, remote changes, mount/dispose, and very-large sparse datasets.
### Specific completion gate
Large sparse grids remain bounded in DOM and memory; canonical changes apply without echo; no workbook/sheet-tab model appears; the dependency/license/performance/a11y decision is recorded.
...
- Spreadsheet-specific: ARIA grid/proxy, large sparse range performance, stable RangeRef, remote structural change, and no workbook/sheet-tab assumptions.
...
- Ω-022: <mention-page url="https://app.notion.com/p/3acb6410e50281edb7f7d5bd3c7d90a8"/>
