---
title: "Α-046 — Slides Canvas, Selection, Viewport & Object Manipulation"
notion_page_id: "3adb6410e50281b3be53f3821894dc9a"
notion_url: "https://app.notion.com/3adb6410e50281b3be53f3821894dc9a"
...
# Α-046 — Slides Canvas, Selection, Viewport & Object Manipulation

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 5 — Editors and resource views
> **Outcome:** Complete the Slides canvas and accessible object interaction for viewport, selection, transforms, snapping, grouping, layer order, clipboard, keyboard movement, and the approved V1 object kinds.
## Why this packet exists
Complete the Slides canvas and accessible object interaction for viewport, selection, transforms, snapping, grouping, layer order, clipboard, keyboard movement, and the approved V1 object kinds. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- pointer-driven Fabric drag/resize/rotate/text edit
- text and rectangle renderers only
- suppressed canvas accessibility warnings and store-only tests
...
- Implement single/multi-selection, group/ungroup, nudge, align/distribute, snapping/guides, z-order, lock/hide, duplicate, and clipboard as runtime actions.
- Gate line/image/table/chart/theme/presenter work through the frozen V1 capability matrix.
- Provide an accessible slide/object tree and semantic keyboard proxy for canvas content.
- Test large decks, selection deletion/recovery, IME text, paste/drop, and repeated canvas disposal.
### Specific completion gate
Drag/resize/rotate previews coalesce to bounded committed operations; stable IDs survive every interaction; pointer and keyboard paths converge; remote changes reconcile without selection corruption.
