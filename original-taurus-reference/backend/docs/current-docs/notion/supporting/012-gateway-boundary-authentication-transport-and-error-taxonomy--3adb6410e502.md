---
title: "Α-012 — Gateway Boundary, Authentication Transport & Error Taxonomy"
notion_page_id: "3adb6410e50281959ba6ea70f4037a0e"
notion_url: "https://app.notion.com/3adb6410e50281959ba6ea70f4037a0e"
...
# Α-012 — Gateway Boundary, Authentication Transport & Error Taxonomy

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 2 — User Cell and Project Subcell runtime
> **Outcome:** Centralize credentials-bearing transport, cancellation, timeouts, retry eligibility, correlation, safe logging, request identity, and typed transport/domain faults.
## Why this packet exists
Centralize credentials-bearing transport, cancellation, timeouts, retry eligibility, correlation, safe logging, request identity, and typed transport/domain faults. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- `src/lib/data/api.ts`
- project retry/withProject behavior
- system-specific direct clients
...
- Distinguish durable idempotency keys from per-attempt RequestIDs.
- Apply one credentials/CSRF/origin policy to every gateway.
- Redact credentials, content, and opaque backend bodies from logs.
- Define cancellation and retry ownership instead of component timers.
### Specific completion gate
No feature, component, or editor constructs fetch/socket transport; session expiry, refusal, conflict, validation, unavailable, malformed, and network failures produce typed outcomes.
