---
title: "Α-027 — Sign-In, Callback, Session Recovery & Sign-Out Experience"
notion_page_id: "3adb6410e502817ba8beca790bb2b883"
notion_url: "https://app.notion.com/3adb6410e502817ba8beca790bb2b883"
...
# Α-027 — Sign-In, Callback, Session Recovery & Sign-Out Experience

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 3 — Shell, routes and control surfaces
> **Outcome:** Complete and visually reconstruct the public authentication experience, callback/recovery states, safe deep-link return, session-expired interruption, and sign-out.
## Why this packet exists
Complete and visually reconstruct the public authentication experience, callback/recovery states, safe deep-link return, session-expired interruption, and sign-out. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- `/login and /join/[token] routes`
- root session layout
- existing sign-in HTML and error states
...
- Use semantic forms/status regions and never expose credential details.
- Validate return destinations and make callback idempotent.
- Preserve recoverable navigation intent without retaining inaccessible content.
- Record approved screenshots for all authentication states.
### Specific completion gate
Keyboard, screen reader, password-manager/provider, open-redirect, double-callback, expired-session, offline, error, and narrow-screen tests pass.
