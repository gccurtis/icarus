---
title: "Α-035 — Resource Explorer, New Tab, Search & Discovery"
notion_page_id: "3adb6410e50281f78391dd29f52e11bd"
notion_url: "https://app.notion.com/3adb6410e50281f78391dd29f52e11bd"
...
# Α-035 — Resource Explorer, New Tab, Search & Discovery

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 4 — Project workspace and panels
> **Outcome:** Complete the Project resource explorer and launcher with large-list search, sort, filters, recent/open state, resource-type creation, discovery results, and open-in-tab behavior.
## Why this packet exists
Complete the Project resource explorer and launcher with large-list search, sort, filters, recent/open state, resource-type creation, discovery results, and open-in-tab behavior. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- ResourceTable
- NewResourcePanel/New Tab
- resource registry and local addResource behavior
...
- Implement launcher resolution in place with the same stable TabID.
- Gate creation by server capability plus installed production stage.
- Use shared virtualized collection patterns and explicit result counts.
- Preserve restricted-resource non-disclosure and deterministic open/reveal behavior.
### Specific completion gate
Loading, empty, many-result, restricted, unavailable-type, stale, concurrent update, and failed-create states pass; no action creates a fake local resource or opens a generic placeholder.
