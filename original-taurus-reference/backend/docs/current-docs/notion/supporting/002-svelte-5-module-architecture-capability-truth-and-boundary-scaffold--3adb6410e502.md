---
title: "Α-002 — Svelte 5 Module Architecture, Capability Truth & Boundary Scaffold"
notion_page_id: "3adb6410e502816e8161de23d0ec440c"
notion_url: "https://app.notion.com/3adb6410e502816e8161de23d0ec440c"
project: "Taurus Yesod"
role: "Supporting"
format: "Spec"
created: "2026-07-30 06:25:48Z"
mirrored_at: "2026-07-30"
mirrored_from_notion: true
---

# Α-002 — Svelte 5 Module Architecture, Capability Truth & Boundary Scaffold

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 0 — Evidence and build foundation
> **Outcome:** Establish the target Svelte 5 module skeleton, composition roots, import boundaries, and a capability-honesty registry that prevents create/open actions from leading to mocks or generic placeholders.
## Why this packet exists
Establish the target Svelte 5 module skeleton, composition roots, import boundaries, and a capability-honesty registry that prevents create/open actions from leading to mocks or generic placeholders. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- `src/lib component, feature, system, data and service layers`
- hard-coded WorkSurface resource dispatch
- forced Slides capability and local non-Document creation
...
- Define public module APIs and dependency direction for runtime, systems, features, editors, and components.
- Create typed resource-stage/capability descriptors without implementing editor engines.
- Remove or quarantine forced capabilities, local fake durable creation, and placeholder-as-success paths.
- Add import-boundary and registry validation to CI.
### Specific completion gate
The current application builds inside the target responsibility map; CI rejects forbidden imports; a resource kind is available only when both Omega advertises it and a production stage is installed.
## Target boundary and contract
```typescript
interface CompletionEvidence {
  baselineCommit: string;
  currentState: readonly ClassifiedSurface[];
  contracts: readonly ContractReference[];
  tests: readonly EvidenceArtifact[];
  residualGaps: readonly ExplicitDeferral[];
}
```
...
Capture the actual rendered Svelte/HTML states that this packet governs. Baselines must be deterministic and show desktop, narrow, loading, empty, error, permission, focus, and applicable editor states. Styling values come only from the centralized visual authorities. Any intentional visual change must have before/after evidence and an updated component or screen fixture.
