---
title: "Α-023 — Interaction, Selection, Focus, Preview & Presence Boundary"
notion_page_id: "3adb6410e50281b0831ad550a2b388e8"
notion_url: "https://app.notion.com/3adb6410e50281b0831ad550a2b388e8"
...
# Α-023 — Interaction, Selection, Focus, Preview & Presence Boundary

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 2 — User Cell and Project Subcell runtime
> **Outcome:** Implement scoped noncanonical state for focus, extensible stable selections, drafts, previews, viewport, direct manipulation, and collaborative presence without mixing those concepts.
## Why this packet exists
Implement scoped noncanonical state for focus, extensible stable selections, drafts, previews, viewport, direct manipulation, and collaborative presence without mixing those concepts. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- closed shared selection unions
- global panel sessions
- editor-native selection callbacks
...
- Use adapter-owned discriminated `SelectionEnvelope<TTarget>` with Project/Resource scope once.
- Map stable Document, Spreadsheet, Slides, Chat, Overview, and task targets.
- Define preview/commit/cancel for sliders, drag, resize, and composition.
- Coordinate focus regions, announcements, keyboard modes, and ephemeral presence separately.
### Specific completion gate
Previewing never creates canonical operations; selection never substitutes for focus; raw ProseMirror/Fabric/grid coordinates remain adapter-local; presence never enters canonical history.
