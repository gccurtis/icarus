---
title: "Α-045 — Slides Domain Runtime, Fabric.js Adapter & Omega Object Bridge"
notion_page_id: "3adb6410e5028103916dde28ea82d7af"
notion_url: "https://app.notion.com/3adb6410e5028103916dde28ea82d7af"
...
# Α-045 — Slides Domain Runtime, Fabric.js Adapter & Omega Object Bridge

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 5 — Editors and resource views
> **Outcome:** Productionize Slides by splitting domain/commands/view state, creating a per-resource revisioned runtime, and isolating Fabric.js 7.4 behind a stable Taurus object adapter.
## Why this packet exists
Productionize Slides by splitting domain/commands/view state, creating a per-resource revisioned runtime, and isolating Fabric.js 7.4 behind a stable Taurus object adapter. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- FabricCanvas.svelte using Fabric 7.4
- global systems/slides/types.ts mock deck/store/random IDs
- fake Saved/edited time and Document presence reuse
...
- Begin with a measured V1 capability/a11y/performance audit; retain Fabric unless evidence proves the adapter cannot meet the contract.
- Split immutable domain model, deterministic IDs, commands, view state, fixtures, client, replica, and adapter.
- Replace clear/rebuild synchronization with tested stable-ID reconcile where practical.
- Remove loadDeck(title), global deck state, fake timestamps/presence, and hard-coded product colors.
### Specific completion gate
Deck state persists through Omega with truthful revisions/status; Fabric JSON is never wire authority; remote/reconcile application cannot echo; two open decks have independent runtimes and durable IDs.
