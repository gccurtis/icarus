---
title: "Α-021 — Feature Modules, Controllers, Selectors & View Models"
notion_page_id: "3adb6410e50281039dcffe3c6c16a768"
notion_url: "https://app.notion.com/3adb6410e50281039dcffe3c6c16a768"
...
# Α-021 — Feature Modules, Controllers, Selectors & View Models

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 2 — User Cell and Project Subcell runtime
> **Outcome:** Make static feature manifests, use-case controllers, pure selectors, immutable view models, and dependency-restricted public ports the composition boundary for every route and feature.
## Why this packet exists
Make static feature manifests, use-case controllers, pure selectors, immutable view models, and dependency-restricted public ports the composition boundary for every route and feature. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- large Svelte feature components
- shared surface and inspector stores
- Document presentation/actions modules
...
- Define dependencies, scope, actions, Context, Inspector, overlays, and disposal in manifests.
- Express loadable/stale/refused/offline/conflict states in view models.
- Use small Svelte composition components for subscription and DOM lifecycle only.
- Enforce no cross-feature controller imports and no DTO leakage in CI.
### Specific completion gate
Controllers contain no Svelte/DOM code; selectors perform no effects; components never receive raw wire models or mutate capability stores.
