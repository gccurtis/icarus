---
title: "Α-050 — Spreadsheet Structure, Formatting, Inspector & Dependency UX"
notion_page_id: "3adb6410e5028193bdfbf65f0a493613"
notion_url: "https://app.notion.com/3adb6410e5028193bdfbf65f0a493613"
...
# Α-050 — Spreadsheet Structure, Formatting, Inspector & Dependency UX

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 5 — Editors and resource views
> **Outcome:** Complete one-grid structural operations, formatting, dimensions, freeze/sort/filter/table entry points where supported, Context lenses, adaptive Inspector, dependency trace, scenarios, and transfer entry points.
## Why this packet exists
Complete one-grid structural operations, formatting, dimensions, freeze/sort/filter/table entry points where supported, Context lenses, adaptive Inspector, dependency trace, scenarios, and transfer entry points. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- no Spreadsheet Context/Inspector implementation in Alpha
- specialized Yesod Spreadsheet lens authorities
- absence of grid/formula UI
...
- Implement row/column insert/delete/resize and governed formatting as typed actions.
- Resolve cell/range/table/dependency selections through stable envelopes.
- Expose sort/filter/table/scenario/dependency features only when the Omega contract supports them.
- Keep CSV/XLSX conversion in transfer jobs, not a multi-sheet runtime.
### Specific completion gate
Large and mixed selections, formula errors, remote row/column changes, read-only/refused state, dependency views, and supported formatting/transfer operations pass without any sheet/tab assumptions.
