---
title: "Α-008 — Form & Selection Primitives"
notion_page_id: "3adb6410e50281d8911fe1435ba73d60"
notion_url: "https://app.notion.com/3adb6410e50281d8911fe1435ba73d60"
...
# Α-008 — Form & Selection Primitives

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 1 — Component and visual substrate
> **Outcome:** Complete the reusable form system for fields, text entry, checkbox, radio, switch, select/listbox/combobox, slider, validation summary, help text, and asynchronous submission.
## Why this packet exists
Complete the reusable form system for fields, text entry, checkbox, radio, switch, select/listbox/combobox, slider, validation summary, help text, and asynchronous submission. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- current form exports
...
- Use label, description, error, and group relationships consistently.
- Define controlled values and semantic events; controls never call clients.
- Support mixed/multiselection and preview-versus-commit where applicable.
- Add keyboard, screen reader, autocomplete, and double-submit tests.
### Specific completion gate
User, Organization, Project, Resource, Context, Inspector, and editor forms require no custom control semantics; invalid, mixed, disabled, read-only, pending, and server-refused states pass tests.
