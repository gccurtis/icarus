---
title: "Α-054 — AI Quarterback & Bottom Prompt Runtime"
notion_page_id: "3adb6410e5028145a6cec0e6073fe0e1"
notion_url: "https://app.notion.com/3adb6410e5028145a6cec0e6073fe0e1"
...
# Α-054 — AI Quarterback & Bottom Prompt Runtime

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 6 — AI, ingestion and interchange
> **Outcome:** Complete the compact/expanded Quarterback prompt runtime, scope display, Ask/Plan/Action modes, submit/run/stream/stop, background status, error recovery, Inspector takeover, and result application choices.
## Why this packet exists
Complete the compact/expanded Quarterback prompt runtime, scope display, Ask/Plan/Action modes, submit/run/stream/stop, background status, error recovery, Inspector takeover, and result application choices. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- QuarterbackDock and ai-agent system
- permanent AI Inspector behavior
- active-tab-derived scope and mock/persona state
...
- Keep V1 canonical modes Ask, Plan, and Action even if availability is capability-driven.
- Never send active TabID as domain authority; resolve explicit Project/resource/selection scope.
- Separate ephemeral bounded context items from authorized Context/resource/attachment/citation references.
- Map acceptance to accepted plans or typed capability transactions; model multi-target preconditions explicitly.
### Specific completion gate
Quarterback lifecycle is controller-driven, Project-scoped, independent of mounted editor, and survives ordinary Workspace-tab changes while tab-bound drafts/view attachments rebase correctly.
...
- Ω-008 (see <mention-page url="https://app.notion.com/p/3adb6410e50281e286aff541de343991"/>)
