---
title: "Α-040 — Collaboration, Comments, Activity & Presence Surfaces"
notion_page_id: "3adb6410e50281ceb74afe850de03ff4"
notion_url: "https://app.notion.com/3adb6410e50281ceb74afe850de03ff4"
...
# Α-040 — Collaboration, Comments, Activity & Presence Surfaces

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 4 — Project workspace and panels
> **Outcome:** Complete participant, comments/thread, stable-anchor, mention, Project activity, live presence/cursor, stale-anchor, and access-loss presentation across supported resources.
## Why this packet exists
Complete participant, comments/thread, stable-anchor, mention, Project activity, live presence/cursor, stale-anchor, and access-loss presentation across supported resources. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- Document collaboration client and project session polling
- Overview/Context activity surfaces
- comments/references/history modules
...
- Adopt resource-specific collaboration endpoints and TTL/heartbeat semantics where available.
- Keep actor attribution, presence, durable activity, comments, and citations distinct.
- Recover predictably from stale/deleted anchors and permission loss.
- Test two-client join/leave, reconnect, revocation, redaction, and assistive announcements.
### Specific completion gate
Ephemeral presence never enters canonical resource history; inaccessible users/resources/evidence are not disclosed; activity and comments reconcile through scoped capabilities.
