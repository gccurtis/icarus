---
title: "Α-009 — Overlay & Navigation Primitives"
notion_page_id: "3adb6410e5028101b602c377835b67ba"
notion_url: "https://app.notion.com/3adb6410e5028101b602c377835b67ba"
...
# Α-009 — Overlay & Navigation Primitives

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 1 — Component and visual substrate
> **Outcome:** Build hardened Dialog, Drawer, Popover, Menu, Tooltip, Toast region, Tabs, Toolbar, Breadcrumbs, navigation list, and keyboard-resizable separator primitives over one focus/layer contract.
## Why this packet exists
Build hardened Dialog, Drawer, Popover, Menu, Tooltip, Toast region, Tabs, Toolbar, Breadcrumbs, navigation list, and keyboard-resizable separator primitives over one focus/layer contract. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- Modal and Drawer without complete focus management
- Menu without complete roving focus/typeahead
- pointer-only SidePanel separator
...
- Keep overlay mechanics feature-neutral and SSR safe.
- Model nested overlays and route-owned cancellation explicitly.
- Make keyboard separator increments and value semantics first-class.
- Migrate representative modal, menu, popover, tooltip, and rail-resize consumers.
### Specific completion gate
Initial focus, containment, background inertness, stacking, Escape, outside dismissal, opener restoration, roving focus, typeahead, arrow/Home/End navigation, and accessible relationships pass DOM tests.
