---
title: "Α-003 — Omega Contract Client, Wire Mappers & Deterministic Fixtures"
notion_page_id: "3adb6410e502814aa4bfc5460a9477aa"
notion_url: "https://app.notion.com/3adb6410e502814aa4bfc5460a9477aa"
...
# Α-003 — Omega Contract Client, Wire Mappers & Deterministic Fixtures

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 0 — Evidence and build foundation
> **Outcome:** Create mechanically checked Alpha-side contracts for every consumed Omega/control-plane endpoint, with branded identities, revisions, operation envelopes, stable DTO mappers, and deterministic fixtures.
## Why this packet exists
Create mechanically checked Alpha-side contracts for every consumed Omega/control-plane endpoint, with branded identities, revisions, operation envelopes, stable DTO mappers, and deterministic fixtures. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- `src/lib/data/api.ts and system-specific clients`
- Alpha backend-request inventory
- current Omega responses at the reviewed backend baseline
...
- Separate wire types, domain projections, view models, and commands.
- Model ProjectID, ResourceID, Revision, durable SubmissionID/idempotency key, and per-attempt RequestID distinctly.
- Decode typed admission, authorization, conflict, validation, unavailable, and retryable faults.
- Provide fixtures for snapshots, change descriptors, jobs, streams, acknowledgements, and malformed responses.
### Specific completion gate
Feature and component code cannot import raw wire DTOs; a deterministic mock Omega/change source exercises every mapped request and documented failure.
