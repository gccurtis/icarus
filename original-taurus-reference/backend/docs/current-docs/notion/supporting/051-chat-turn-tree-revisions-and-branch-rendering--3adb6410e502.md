---
title: "Α-051 — Chat Turn Tree, Revisions & Branch Rendering"
notion_page_id: "3adb6410e502812d803dcedc917f4601"
notion_url: "https://app.notion.com/3adb6410e502812d803dcedc917f4601"
...
# Α-051 — Chat Turn Tree, Revisions & Branch Rendering

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 5 — Editors and resource views
> **Outcome:** Implement a Chat Resource replica and stage for the authoritative revisioned Prompt+Response turn tree, independent of Project Quarterback state.
## Why this packet exists
Implement a Chat Resource replica and stage for the authoritative revisioned Prompt+Response turn tree, independent of Project Quarterback state. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- Chat kind/create affordance and generic placeholder
- no Chat Resource system/stage
- Quarterback ai-agent system that must remain separate
...
- Freeze V1 Ask/Plan/Action mode and Prompt+Response pair contracts.
- Render a tree/branch model rather than flattening to a message array.
- Treat stream deltas as transient until Omega commits a durable revision.
- Register independent Chat Context, Inspector, actions, history, and lifecycle.
### Specific completion gate
Stable turn, revision, parent, branch, alternate response, status, citation, and tool-activity identity survives refresh, remote changes, branch navigation, and Workspace detach.
