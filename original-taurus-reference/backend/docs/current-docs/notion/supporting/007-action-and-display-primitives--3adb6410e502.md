---
title: "Α-007 — Action & Display Primitives"
notion_page_id: "3adb6410e5028107bdf9d8c9b93851aa"
notion_url: "https://app.notion.com/3adb6410e5028107bdf9d8c9b93851aa"
...
# Α-007 — Action & Display Primitives

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 1 — Component and visual substrate
> **Outcome:** Complete Button, IconButton, Link, Avatar, Icon, status indicator, disclosure, chip/tag, and controlled display contracts used by every screen and editor.
## Why this packet exists
Complete Button, IconButton, Link, Avatar, Icon, status indicator, disclosure, chip/tag, and controlled display contracts used by every screen and editor. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- current atom exports and feature-local action markup
- icon-only shell/editor controls
- current status/avatar implementations
...
- Make semantic element choice explicit and prevent clickable divs.
- Separate unavailable, read-only, disabled, and pending states.
- Standardize confirmation severity and destructive presentation.
- Migrate a representative shell, settings form, and editor toolbar slice.
### Specific completion gate
Keyboard, focus-visible, pressed, expanded, loading, disabled, read-only, destructive, icon-only, accessible-name, and high-contrast states are tested and catalogued.
