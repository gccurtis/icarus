---
title: "Α-039 — Inspector & Section Provider System"
notion_page_id: "3adb6410e5028145be60e6875bee91fd"
notion_url: "https://app.notion.com/3adb6410e5028145be60e6875bee91fd"
...
# Α-039 — Inspector & Section Provider System

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 4 — Project workspace and panels
> **Outcome:** Implement adaptive Inspector resolution over extensible stable selection envelopes and resource/feature-owned section providers, including mixed values, previews, commits, read-only and unavailable properties.
## Why this packet exists
Implement adaptive Inspector resolution over extensible stable selection envelopes and resource/feature-owned section providers, including mixed values, previews, commits, read-only and unavailable properties. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- InspectorPanel
- closed inspector-options target union
- per-stage Inspector components and global sessions
...
- Resolve `SelectionEnvelope<TTarget>` through explicit adapter/provider registration.
- Represent no selection, single, multi, mixed, stale, deleted, refused, and read-only states.
- Keep engine coordinates and component instances out of generic contracts.
- Implement Quarterback takeover/restore without making AI a permanent Inspector facet.
### Specific completion gate
Document, Slides, one-grid Spreadsheet, Chat, Overview, and task selections receive only valid sections; continuous controls preview locally and emit one committed operation.
