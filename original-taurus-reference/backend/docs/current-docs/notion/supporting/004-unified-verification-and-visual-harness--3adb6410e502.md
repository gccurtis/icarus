---
title: "Α-004 — Unified Verification & Visual Harness"
notion_page_id: "3adb6410e502817b9f99f7ca6a86d962"
notion_url: "https://app.notion.com/3adb6410e502817b9f99f7ca6a86d962"
...
# Α-004 — Unified Verification & Visual Harness

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 0 — Evidence and build foundation
> **Outcome:** Create one documented verification harness spanning pure logic, Svelte DOM components, browser E2E, accessibility, keyboard behavior, screenshot regression, deterministic network faults, and real-stack smoke tests.
## Why this packet exists
Create one documented verification harness spanning pure logic, Svelte DOM components, browser E2E, accessibility, keyboard behavior, screenshot regression, deterministic network faults, and real-stack smoke tests. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- Vitest in node environment
- serial Chromium-only Playwright suite
- absence of DOM component, axe, and screenshot baselines
...
- Keep pure Node suites separate from DOM component suites.
- Add permissively licensed DOM/a11y tooling and record every new dependency license.
- Create User Cell, Project Subcell, resource, revision, and fault fixtures.
- Define supported viewport/browser matrices and deterministic clock/network controls.
### Specific completion gate
CI can run all layers from a clean checkout and emits artifacts for screenshots, accessibility results, browser traces, test counts, and failure diagnostics.
