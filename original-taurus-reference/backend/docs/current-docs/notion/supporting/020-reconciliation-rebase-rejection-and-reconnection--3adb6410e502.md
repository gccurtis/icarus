---
title: "Α-020 — Reconciliation, Rebase, Rejection & Reconnection"
notion_page_id: "3adb6410e50281ba8aeac72f0256427a"
notion_url: "https://app.notion.com/3adb6410e50281ba8aeac72f0256427a"
...
# Α-020 — Reconciliation, Rebase, Rejection & Reconnection

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 2 — User Cell and Project Subcell runtime
> **Outcome:** Define one tested reconciliation model for remote interleaving, local replay, revision gaps, typed rejection, permission loss, reconnect, and fatal recovery.
## Why this packet exists
Define one tested reconciliation model for remote interleaving, local replay, revision gaps, typed rejection, permission loss, reconnect, and fatal recovery. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- Document conflict reload/retry
- project retry helper
- unrevisioned local mocks
...
- Rebase pending operations only through resource-specific reducers/validators.
- Treat revocation as authoritative and purge inaccessible projections.
- Preserve user recovery artifacts without retaining unauthorized content.
- Surface retry, reload, copy-out, or discard choices through typed controller outcomes.
### Specific completion gate
Sabotage tests prove convergence to Omega without silent data loss; rejected or unmappable work remains explainable and recoverable.
