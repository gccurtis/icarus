---
title: "Α-024 — Overlay, Keymap & Notification Runtimes"
notion_page_id: "3adb6410e50281489af5fa4d21b720c7"
notion_url: "https://app.notion.com/3adb6410e50281489af5fa4d21b720c7"
...
# Α-024 — Overlay, Keymap & Notification Runtimes

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 2 — User Cell and Project Subcell runtime
> **Outcome:** Build typed blocking workflow overlays, keyboard-scope stacking, global command routing, focus restoration, notification retention, and asynchronous overlay outcomes over the hardened primitives.
## Why this packet exists
Build typed blocking workflow overlays, keyboard-scope stacking, global command routing, focus restoration, notification retention, and asynchronous overlay outcomes over the hardened primitives. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- component-local Escape/focus logic
- feature-local modal flags
- global shortcuts and toasts
...
- Distinguish blocking decisions, transient popovers, menus, tooltips, and retained notifications.
- Own overlays by route/feature/runtime scope and cancel or transfer explicitly.
- Prevent shortcuts from leaking through active modal/editor scopes.
- Test delayed async completion after navigation, sign-out, and Project disposal.
### Specific completion gate
No screen owns unrelated modal booleans; nested workflows, route navigation, Project release, cancellation, errors, and focus restoration behave deterministically.
