---
title: "Α-049 — Spreadsheet Navigation, Editing, Clipboard & Formula Interface"
notion_page_id: "3adb6410e50281468b8adfd3d58bf31b"
notion_url: "https://app.notion.com/3adb6410e50281468b8adfd3d58bf31b"
...
# Α-049 — Spreadsheet Navigation, Editing, Clipboard & Formula Interface

> Source mirror. Preserve this page as planning evidence; use the agent-facing execution packet when one exists.

> **Status:** Queued
> **Wave:** Wave 5 — Editors and resource views
> **Outcome:** Implement keyboard navigation, selections, edit mode, formula/name bars, value/formula distinctions, reference highlighting, copy/cut/paste/fill, typed errors, and recalculation status for the one-grid model.
## Why this packet exists
Implement keyboard navigation, selections, edit mode, formula/name bars, value/formula distinctions, reference highlighting, copy/cut/paste/fill, typed errors, and recalculation status for the one-grid model. This packet is bounded so an implementation agent can complete it without inventing adjacent architecture. It is not complete until the old behavior is either migrated with parity evidence or explicitly removed.
## Current Alpha evidence to inspect
- no Spreadsheet editor HTML or tests
- new-resource Spreadsheet affordance
- backend formula/range authorities
...
- Define commit/cancel/composition behavior and bounded paste/fill batches.
- Use backend formula semantics/evaluation rather than a competing client engine.
- Model references, names, dependency/recalculation state, and errors explicitly.
- Test mixed formats, empty/large ranges, remote structural change, conflict, and read-only mode.
### Specific completion gate
Values, formulas, display/format, names, errors, and stable ranges round-trip without lossy frontend coercion; pointer and keyboard editing produce the same typed actions.
