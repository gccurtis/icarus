---
title: "Execute Ω-012 — Land the Workspace aggregate and unified undo"
packet_id: "Ω-012"
status: "ready-for-execution"
wave: "Wave 1 — Close the Project runtime"
depends_on: "Ω-010, Ω-011"
source_mirror: "docs/current-docs/notion/work-packets/omega-012-land-the-workspace-aggregate-and-unified-undo.md"
frozen_planning_baseline: "50efd18413cc47935033889e51d58e9c828733e2"
generated_at: "2026-07-30"
---

# Execute Ω-012 — Land the Workspace aggregate and unified undo

## Mission

Replace the opaque Workspace blob with the typed, revisioned user×Project aggregate defined by the current Workspace Primary. The aggregate canonically persists system, launcher, and Resource tabs; active tab; workspace-wide panel geometry; per-tab Context, Inspector, target, and Resource-view envelopes; and immutable private shell history. Workspace also owns the unified undo coordinator that arbitrates between shell history and the visible active Resource’s history. Undo never mutates hidden content: a later shell action is compensated first, and a Resource target must be mounted and revealed before its content compensation can run. Workspace is personal shell state hosted through the user’s `(UserID, ProjectID)` Project Subcell. It is not itself a backend cell or a shared Project runtime.
...
Hard predecessors: **Ω-010, Ω-011**.

Source dependency statement: Ω-010 and Ω-011.
...
- `docs/current-docs/notion/work-packets/omega-012-land-the-workspace-aggregate-and-unified-undo.md` — exact Notion source mirror for this packet.
...
- `docs/current-docs/notion/supporting/architecture-frontend-synchronization-replicas-and-reconciliation--3adb6410e502.md`
- `docs/current-docs/notion/supporting/architecture-workbench-shell-workspace-and-stage-lifecycle--3adb6410e502.md`
- `docs/current-docs/notion/supporting/implementation-workspace-backend--3acb6410e502.md`
- `docs/current-docs/notion/supporting/implementation-workspace-frontend--3acb6410e502.md`
...
Source mirror: `docs/current-docs/notion/work-packets/omega-012-land-the-workspace-aggregate-and-unified-undo.md`
