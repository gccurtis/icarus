...
import { ResourceRuntimes } from "$model/client/resource-runtimes/definition.svelte";
import type { ResourceRuntimesModel } from "$model/client/resource-runtimes/types";
 ...
 * which is why nothing here has to release anything.
 *
 ...
 */
export const createResourceRuntimes = (
  configuration: ConfigurationModel
): ResourceRuntimesModel =>
  new ResourceRuntimes({
