 ...
 */
export const buffer = (runtime: Runtime, ops: readonly Op[]): void => {
 ...
 * unreachable. Keeping it would offer a redo that reapplies ops against a
 * revision that no longer follows from them.
 *
 ...
 */
export const apply = (runtime: Runtime, ops: readonly Op[]): void => {
