...
import { invertAll } from "$model/client/resource-runtimes/methods/history/invert";
 ...
 */
export const undo = (runtime: Runtime): readonly Op[] => {
 ...
 */
export const redo = (runtime: Runtime): readonly Op[] => {
