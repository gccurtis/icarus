...
import { invertAll } from "$model/client/presentation-runtimes/methods/history/invert";

export const undo = (runtime: Runtime): readonly PresentationOp[] => {
...
export const redo = (runtime: Runtime): readonly PresentationOp[] => {
