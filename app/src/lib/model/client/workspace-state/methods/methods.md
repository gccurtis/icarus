...
| `pendingFlight` | file | [`pending-flight.ts`](pending-flight.ts) | observer | Read a matching command promise without acquiring or replacing it |
| `presentationRuntime` | file | [`presentation-runtime.ts`](presentation-runtime.ts) | accessor | The runtime a presentation already has, from the register this object borrows |
