<script lang="ts">
	...
	import type { WithoutChildrenOrChild } from "$lib/components/vendor/utils.js";
	...
	>
		...
		<TooltipPrimitive.Arrow>
			{#snippet child({ props })}
				<div
					class={cn(
						"size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px] z-50 bg-foreground fill-foreground",
