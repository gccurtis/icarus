...
<script lang="ts">
	...
	import * as Tooltip from "$lib/components/vendor/tooltip/index.js";
	import { cn, type WithElementRef, type WithoutChildrenOrChild } from "$lib/components/vendor/utils.js";
