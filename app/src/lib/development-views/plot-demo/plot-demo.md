...
Lives at `src/lib/development-views/plot-demo/plot-demo.md`. Trees live in the concern
...
- `$components/authored/chart` — the spec, the marks and the selection
- `$components/authored/panel` — the controls and the selection panel
- `$components/authored/screen` — the surface
