...
Lives at `src/lib/development-views/blocks-demo/blocks-demo.md`. Trees live in the concern
...
- `$components/authored/block` — the subject
- `$components/authored/panel` — the inspector
- `$components/authored/screen` — the surface around both
