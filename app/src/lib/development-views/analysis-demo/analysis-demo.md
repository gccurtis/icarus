...
Lives at `src/lib/development-views/analysis-demo/analysis-demo.md`. Trees live in the
...
- `$components/authored/chart` — the subject
- `$components/authored/screen` — the surface around it
- `$components/authored/panel` — the controls and the editable cells
