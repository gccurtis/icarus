<script lang="ts">
  ...
  import ChartStage from "$development-views/analysis-demo/components/chart-stage.svelte";
  import DataTable from "$development-views/analysis-demo/components/data-table.svelte";
