...
export const ACROSS_FINDINGS: readonly Finding[] = [
  {
    ...
    evidence: ["document-editor/inspector/comment.svelte", "presentation-editor/inspector/comment.svelte"]
  },
  {
    id: "BOTH-02",
    area: "Across both editors",
    ...
    symptom: "Document Show must restore an inline anchor while presentation Show must reveal a slide or element; one general lens obscures those different promises.",
    cause: "The entire comment presentation lives under general/ even though locating is editor-owned behavior.",
    fix: "Keep low-level represented comment procedures reusable but give document and presentation independent copied lenses and explicit locate contracts.",
    acceptance: "Each editor owns and tests its Comment lens while both retain the same visual sequence.",
    evidence: ["document-editor/inspector/comment.svelte", "presentation-editor/inspector/comment.svelte", "representation/data/types/workspace/views.ts"]
  },
  {
    id: "BOTH-03",
    area: "Across both editors",
    ...
    evidence: ["document-editor/inspector", "presentation-editor/inspector", "components/authored/panel"]
  }
];
