...
export const REPLAY_COMMITS: readonly ReplayCommit[] = [
  ...
  { hash: "2b374c9", subject: "Make slots explicitly", phase: "templates" },
  { hash: "d6ad57a", subject: "Account for base and open link", phase: "templates" },
  { hash: "6e02f2d", subject: "Treat every prompt as a slot", phase: "templates" },
  { hash: "03895f1", subject: "Make slots; never find them", phase: "templates" },
  ...
  { hash: "7211f1c", subject: "Recertify the latest-main landing plan", phase: "audit" }
] as const;
