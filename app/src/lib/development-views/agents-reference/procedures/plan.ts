...
export const FILES: readonly PlannedFile[] = [
  ...
  { path: "app/seed/personaThreads.json", status: "create", area: "seed", phase: 1, purpose: "Five chats." },
  ...
  { path: "app/src/lib/capabilities/store/api/read/scoped-read.ts", status: "modify", area: "capability", phase: 2, purpose: "personaThreads become readable, so a chat tab has a title." },
