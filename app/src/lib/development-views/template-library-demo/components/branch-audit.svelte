...
<div class="audit">
  <div class="audit-proof">
    ...
    <p>
      ...
      <code>app/src/lib/app-views/categories/new-tab</code> relative to the feature baseline.
    </p>
  </div>
  ...
  <div class="audit-warning">
    ...
    <p>
      <strong>Review boundary:</strong> this is the complete diff from <code>a1cdb53</code> to this
      branch snapshot. Every changed path is written in full. The generated
