...
<div class="reference-shell">
  ...
  <main>
    <section class="hero">
      ...
      <aside class="branch-card">
        ...
        <code>work/template-library-replay</code>
        <dl>
    ...
    <section id="justifications" class="section">
      <div class="section-heading">
        ...
        <p>
          ...
          why its area is in scope, and the exact unified diff captured against the newest main tip.
        </p>
      </div>
      <BranchAudit />
    </section>
  ...
  <footer>
    ...
    <span>work/template-library-replay</span>
  </footer>
</div>
