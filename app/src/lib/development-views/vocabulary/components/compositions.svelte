...
<section class="flex flex-col gap-4">
  ...
  <div class="flex flex-wrap items-start gap-6">
    <div class="flex flex-col gap-2">
      ...
      <pre
        class="text-mono border-border-subtle bg-surface-canvas rounded-control text-ink-secondary m-0 w-80 overflow-x-auto border p-3 font-mono">{HEALTH}</pre>
      <div class="w-80">
    ...
    <div class="flex flex-col gap-2">
      ...
      <pre
        class="text-mono border-border-subtle bg-surface-canvas rounded-control text-ink-secondary m-0 w-80 overflow-x-auto border p-3 font-mono">{CONNECTOR}</pre>
      <div class="w-80">
