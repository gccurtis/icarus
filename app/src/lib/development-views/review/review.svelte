<script lang="ts">
  ...
  import GridMap from "$development-views/review/components/grid-map.svelte";
  import Picker from "$development-views/review/components/picker.svelte";
  import StatePanel from "$development-views/review/components/state-panel.svelte";
  import Tree from "$development-views/review/components/tree.svelte";
  import { Review, type ReviewKind } from "$development-views/review/shared/create-review.svelte";
