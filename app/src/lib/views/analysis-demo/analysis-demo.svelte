<script lang="ts">
  ...
  import ChartStage from "$views/analysis-demo/components/chart-stage.svelte";
  import DataTable from "$views/analysis-demo/components/data-table.svelte";
  import { ChartColors, copyChart } from "$lib/unique-components/chart";
