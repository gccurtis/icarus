<script lang="ts">
  import BlockInspector from "$views/blocks-demo/components/block-inspector.svelte";
  import DocumentSurface from "$views/blocks-demo/components/document-surface.svelte";
  import SlideSurface from "$views/blocks-demo/components/slide-surface.svelte";
