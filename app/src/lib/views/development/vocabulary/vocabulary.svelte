<script lang="ts">
  ...
  import Choosing from "$views/development/vocabulary/components/choosing.svelte";
  import Commented from "$views/development/vocabulary/components/commented.svelte";
  import Compositions from "$views/development/vocabulary/components/compositions.svelte";
  import DataShapes from "$views/development/vocabulary/components/data-shapes.svelte";
  import Dragging from "$views/development/vocabulary/components/dragging.svelte";
  import Editing from "$views/development/vocabulary/components/editing.svelte";
  import PanelFacts from "$views/development/vocabulary/components/panel-facts.svelte";
  import PanelParts from "$views/development/vocabulary/components/panel-parts.svelte";
  import PanelShapes from "$views/development/vocabulary/components/panel-shapes.svelte";
  import PanelValues from "$views/development/vocabulary/components/panel-values.svelte";
