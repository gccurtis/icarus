<script lang="ts">
  ...
  import ThreadAbout from "$views/thread-demo/components/thread-about.svelte";
  import ThreadComposer from "$views/thread-demo/components/thread-composer.svelte";
  import ThreadTurn from "$views/thread-demo/components/thread-turn.svelte";
  import TurnFinding from "$views/thread-demo/components/turn-finding.svelte";
  import TurnTools from "$views/thread-demo/components/turn-tools.svelte";
  import { PanelProgress, PanelQuote } from "$lib/unique-components/panel";
  import {
    ScreenEmpty,
    ScreenGroup,
    ScreenHeader,
