...
Lives at `src/lib/views/vocabulary/vocabulary.md`. Trees live in the concern
...
- `$lib/unique-components/panel` — the family being documented
- `$lib/unique-components/screen` — the other family being documented
- `$lib/simple-components/separator` — between sections
