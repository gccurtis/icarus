                  ...
                  {#each on(page.number) as piece (piece.key)}
                    ...
                    {:else if piece.kind === "heading"}
                      <button
                        ...
                        onclick={() => inspect("resource.text-block-document", "block", piece.key)}
                      >
                        {piece.text}
                      </button>
                    ...
                    {:else if piece.kind === "generated"}
                      <button
                        ...
                        class="block-run text-body-sm text-ink-secondary"
                        class:is-selected={selected === piece.key}
                        onclick={() => inspect("resource.prompt-block", "block", piece.key)}
                        title={piece.prompt}
                      >
                        <!--
                    ...
                    {:else}
                      <button
                        ...
                        class="block-run"
                        class:is-selected={selected === piece.key}
                        onclick={() => inspect("resource.table", "table", piece.key)}
                      >
                        <!--
