...
] as const satisfies readonly InspectorView[];

export const isContextView = (value: string): value is ContextView =>
  (CONTEXT_VIEWS as readonly string[]).includes(value);

export const isInspectorView = (value: string): value is InspectorView =>
  (INSPECTOR_VIEWS as readonly string[]).includes(value);
