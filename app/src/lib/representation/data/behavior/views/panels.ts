...
export const CONTEXT_IDS = [
  ...
  "scope.knowledge",
  "scope.used-by"
] as const satisfies readonly ContextId[];
...
export const INSPECTION_KEYS = [
  ...
  "scope.search-result",
  "scope.take-out-kind"
] as const satisfies readonly InspectionKey[];
...
type Unlisted<Union, Listed extends readonly Union[]> = Exclude<Union, Listed[number]>;

export type EveryContextIsListed = None<Unlisted<ContextId, typeof CONTEXT_IDS>>;
export type EveryInspectionIsListed = None<Unlisted<InspectionKey, typeof INSPECTION_KEYS>>;
