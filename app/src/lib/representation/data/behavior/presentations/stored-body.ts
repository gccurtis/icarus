...
} from "$representation/data/behavior/presentations/stored-element";
import type {
  PresentationSection,
  Slide,
  PresentationBody,
...
const isStoredSection = (value: unknown): value is PresentationSection => {
...
export const isStoredPresentationBody = (value: unknown): value is PresentationBody => {
