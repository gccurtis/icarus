...
const identifierMint = (body: PresentationBody) => {
...
/** Fulfil editor invariants within the one current presentation schema. */
export const ensurePresentationReady = (body: PresentationBody): PresentationBody => {
