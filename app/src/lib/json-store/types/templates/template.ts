...
import type { Mark } from "$json-store/types/content/content-block";
import type { VariableValue } from "$json-store/types/content/variable-value";
import type { TemplatedResourceSet } from "$json-store/types/core/resource-set";
...
import type { AspectRatio, SlideDeckBody } from "$json-store/types/resources/slide-deck-body";
import type { PrintScale } from "$json-store/types/resources/spreadsheet-body";
