<script lang="ts">
  ...
  import CommandBar from "$surfaces/command-bar/command-bar.svelte";
  import { dispatchCommands } from "$surfaces/app/effects/dispatch-commands.svelte";
  ...
  import StatusBar from "$surfaces/status-bar/status-bar.svelte";
  import TabBar from "$surfaces/tab-bar/tab-bar.svelte";
  import TopBar from "$surfaces/top-bar/top-bar.svelte";
