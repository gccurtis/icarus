...
Lives at `src/lib/surfaces/inspector/inspector.md`. Trees live in the concern
...
- what a lens contains. Each of the lenses under `$lib/app-views/panels/inspector/` renders
