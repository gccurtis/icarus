...
export const RAIL_ENTRIES: Record<ContextView, RailEntry> = {
  ...
  "presentation-editor.prompts": { label: "Prompts", icon: Sparkles },
  ...
  "presentation-editor.variables": { label: "Variables", icon: Hash },
  ...
  "presentation-editor.comments": { label: "Comments", icon: MessageSquare },
  ...
  "presentation-editor.slides": { label: "Slides", icon: Presentation },
  "presentation-editor.templates": { label: "Templates", icon: LayoutPanelTop },
  "document-editor.styles": { label: "Styles", icon: Type },
  "spreadsheet-editor.styles": { label: "Styles", icon: Type },
  "presentation-editor.theme": { label: "Style", icon: Palette },
