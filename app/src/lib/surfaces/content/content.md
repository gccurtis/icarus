...
Lives at `src/lib/surfaces/content/content.md`. Trees live in the concern
...
- **Entry:** [`content.svelte`](content.svelte)
- **Types:** `None`
...
The thirteen centres under `$lib/app-views/workspaces/` are reached through a glob rather
