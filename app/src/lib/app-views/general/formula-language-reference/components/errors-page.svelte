<script lang="ts">
  ...
  import { BEHAVIOUR, RULED, TOKENS } from "$app-views/general/formula-language-reference/procedures/errors";
  ...
  <div class="page">
    ...
    <section>
      <div class="section-head">
        <h2>Every token</h2>
        <p>What raises it, and whether it is raised today.</p>
      </div>
      <SpecTable grid={TOKENS} />
    </section>

    <section>
      <div class="section-head">
        <h2>How a refusal behaves</h2>
        <p>Six rules, all of them already in code.</p>
      </div>
      <CardList cards={BEHAVIOUR} />
    </section>
