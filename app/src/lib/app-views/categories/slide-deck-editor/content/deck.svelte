            ...
            {#if editing}
              ...
              {#each owned as object (object.id)}
                <button
                  ...
                  onclick={() => inspect("slide-deck-editor.locked-element", "element", object.id)}
                >
              ...
              {#each slots as slot (slot.index)}
                <button
                  ...
                  onclick={() =>
                    inspect("slide-deck-editor.placeholder", "placeholder", `${editing.id}:${slot.index}`)}
                >
                  <span class="text-ink-muted flex items-center gap-1">
            ...
            {:else}
              ...
              {#each painted as { layer, box: shape } (layer.id)}
                <button
                  ...
                  onclick={() => inspect("slide-deck-editor.element", "element", shape.id)}
                >
                  {#if layer.kind === "chart"}
                    <!--
