import type { Frame, Slide, SlideElement } from "$representation/data/types/slide-decks/body";
import { within } from "$app-views/categories/slide-deck-editor/procedures/deck-geometry";
