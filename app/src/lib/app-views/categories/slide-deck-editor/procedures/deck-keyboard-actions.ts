...
import { withGrouped, withUngrouped } from "$app-views/categories/slide-deck-editor/procedures/deck-layering";
import { placedOn } from "$app-views/categories/slide-deck-editor/procedures/deck-placement";
import { blockIn, elementIn, textOf } from "$app-views/categories/slide-deck-editor/procedures/deck-reading";
import { rangeOf } from "$app-views/categories/slide-deck-editor/procedures/selecting";
import { toggledMark } from "$app-views/categories/slide-deck-editor/procedures/typing";

export const createDeckKeyboardAction = (
  context: DeckActionContext,
  selection: DeckSelectionActions,
  geometry: DeckGeometryActions
