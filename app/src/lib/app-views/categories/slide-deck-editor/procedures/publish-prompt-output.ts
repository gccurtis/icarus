import { promptBlockIn, syncPromptBlockOps } from "$app-views/categories/slide-deck-editor/procedures/prompt-blocks";
...
/** Publishes a newly observed Derived Output through the deck's ordinary op stream. */
export const publishPromptOutput = async ({
  ...
  readonly runtime: SlideDeckRuntime;
}): Promise<void> => {
