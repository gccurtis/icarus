    ...
    {:else}
      <div class="save">
        ...
        <div class="save-actions">
          <PanelButton label="Save deck" tone="primary" disabled={busy || unnamed} title={unnamed ? "Give the template a name first" : "Copy the whole deck into a new template and open it"} onclick={() => state.saveAs()} />
