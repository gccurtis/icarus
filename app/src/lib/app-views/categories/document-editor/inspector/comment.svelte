<script lang="ts">
  ...
  import { commentThreadCommand } from "$app-views/categories/document-editor/procedures/comment-thread-command.svelte";
  import {
    commentsQuery,
    peopleIn,
    remarksIn,
  ...
  import { blockIdOf } from "$app-views/categories/document-editor/procedures/comment-anchors";
  import { ago, nameOf, textOf, userIdOf } from "$app-views/categories/document-editor/procedures/comment-copy";
