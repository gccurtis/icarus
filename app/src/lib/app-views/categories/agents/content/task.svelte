<script lang="ts">
  ...
  import TaskQuestions from "$app-views/categories/agents/components/task-questions.svelte";
  ...
  import { orderedTools, type TaskQuestion } from "$app-views/categories/agents/procedures/vocabulary";
    ...
    {:else}
      ...
      <div class="body work">
        ...
        <div class="split">
          ...
          <TaskQuestions {task} {surface} now={clock.now} onsettle={settle} />
        </div>
