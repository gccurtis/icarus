 ...
 *
 * **`undefined` is a real answer.** Only Document and Slide deck currently
 * consume represented resource ids. Opening a represented spreadsheet or
 * research thread in its mock-backed surface would claim the selected row had
 * loaded when it had not.
 */
