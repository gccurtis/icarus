<script lang="ts">
  ...
  import { slideUnits } from "$app-views/categories/presentation-editor/procedures/stage";
...
<Panel title="Line">
  {#snippet crumbs()}
    <PanelCrumbs
      trail={[{ label: "Presentation" }, { label: `Slide ${position}`, key: "presentation-editor.slide" }, { label: "Line" }]}
