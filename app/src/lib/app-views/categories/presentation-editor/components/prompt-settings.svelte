<script lang="ts">
  ...
  import { PromptSettingsState } from "$app-views/categories/presentation-editor/components/prompt-settings.state.svelte";
  import { readPromptOutput } from "$app-views/categories/presentation-editor/procedures/read-prompt-output";
  import { setPromptScope } from "$app-views/categories/presentation-editor/procedures/set-prompt-scope";
  import { refreshPromptBlock } from "$app-views/categories/presentation-editor/procedures/refresh-prompt-block";
  import { synchronizePromptSettings } from "$app-views/categories/presentation-editor/procedures/effects/prompt-settings.svelte";
  import { publishesPromptOutput } from "$app-views/categories/presentation-editor/procedures/effects/publishes-prompt-output.svelte";
  import { publishPromptOutput } from "$app-views/categories/presentation-editor/procedures/publish-prompt-output";
  import { inspectExternalFile } from "$app-views/categories/external/procedures/inspect-file";
  import {
    compactEvidenceSourceTitle,
    exactEvidenceText
  } from "$app-views/categories/presentation-editor/procedures/evidence";
...
{:else if block === undefined || runtime === undefined}
  <PanelBanner title="The Prompt Block is missing" tone="attention">
    The presentation no longer contains the Prompt Block linked to this Derived Output.
  </PanelBanner>
