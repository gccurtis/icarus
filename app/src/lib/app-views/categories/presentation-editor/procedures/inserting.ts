...
import { emptyText, withInsertedElements } from "$app-views/categories/presentation-editor/procedures/presentation-elements";
...
export const makeElement = (kind: PlacedKind, body: PresentationBody, frame: Frame): SlideElement => {
