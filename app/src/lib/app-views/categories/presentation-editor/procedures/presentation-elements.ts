...
import type { ElementContent, Slide, PresentationBody, SlideElement } from "$representation/data/types/presentations/body";
...
export const withInsertedElements = (
  ...
  if (slide === undefined || elements.length === 0) return noPresentationEdit(body);
...
export const withoutElements = (body: PresentationBody, ids: readonly string[]): Edit => {
...
export const withDuplicatedElements = (body: PresentationBody, ids: readonly string[]): Edit => {
