...
const currentPrompt = (runtime: PresentationRuntime, blockId: string): LinkedPromptBlock => {
  ...
  if (block?.derivedOutputId === undefined) {
    throw new Error("The Prompt Block is no longer linked in the presentation");
  }
