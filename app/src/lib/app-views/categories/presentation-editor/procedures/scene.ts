...
import { styleOf } from "$app-views/categories/presentation-editor/procedures/presentation-reading";
import type { Size } from "$app-views/categories/presentation-editor/procedures/stage";
import { columnsOf, gridOf, type GridCell } from "$app-views/categories/presentation-editor/procedures/tables";
...
const cellSceneOf = (body: PresentationBody, placed: GridCell, header: boolean): CellScene => {
...
const itemOf = (body: PresentationBody, element: SlideElement, frame: Frame, depth: number, parents: readonly string[]): Item => {
...
export const sceneOf = (body: PresentationBody, slide: Slide | undefined, units: Size): Scene => {
