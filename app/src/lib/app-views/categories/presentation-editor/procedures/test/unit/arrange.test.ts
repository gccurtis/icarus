...
import { aligned, bounds, distributed, matched, restacked } from "$app-views/categories/presentation-editor/procedures/arrange";
import { snapped, targetsOf } from "$app-views/categories/presentation-editor/procedures/snapping";
import { diffed, replaced, stylesAt, toggledMark } from "$app-views/categories/presentation-editor/procedures/typing";
