...
import type { PresentationActionContext, PresentationSelectionActions } from "$app-views/categories/presentation-editor/procedures/presentation-action-context";
...
import { clampZoom } from "$app-views/categories/presentation-editor/procedures/stage";

const GUTTER = 24;
const WHEEL_NOTCH = 120;
const PERCENT_PER_NOTCH = 2;

export const createPresentationZoomActions = (
