...
export const cellsSignal = (tableId: string, cellIds: readonly string[]): Signal => ({
  key: "presentation-editor.cell",
  selection: { kind: CELLS, id: tableId, ids: cellIds }
});

const LENS: Record<SlideElement["content"]["type"], InspectorView> = {
  text: "presentation-editor.text-box",
  formula: "document-editor.formula",
  prompt: "presentation-editor.prompt-block",
  shape: "presentation-editor.shape",
  line: "presentation-editor.line",
  image: "presentation-editor.image",
  table: "presentation-editor.table",
  chart: "presentation-editor.chart",
  group: "presentation-editor.group"
};
