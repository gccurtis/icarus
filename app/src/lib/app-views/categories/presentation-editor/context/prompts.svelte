<script lang="ts">
  ...
  import { promptBlocksIn } from "$app-views/categories/presentation-editor/procedures/prompt-blocks";
...
<Panel title="Prompts">
  <section class="prompt-index" aria-labelledby="presentation-prompts-heading">
    <h3 id="presentation-prompts-heading">In this presentation</h3>
    {#if prompts.length === 0}
