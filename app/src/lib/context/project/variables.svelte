<script lang="ts">
  ...
  import { HoverCard, HoverCardContent, HoverCardTrigger } from "$lib/simple-components/hover-card";
  import { Separator } from "$lib/simple-components/separator";
  import { variableFamily, variables } from "$mock-capabilities/project";
  import VariablesCreate from "$context/project/variables-create.svelte";
