...
| Concrete sink | [`create/logger.ts`](../../../initialization/runtimes/logger.ts) | Directory creation, daily filename, JSON serialization, synchronous append |
| Composition | [`create-runtime.ts`](../../../initialization/create-runtime.ts) | Creates one logger and injects it process-wide |
| HTTP events | [`registerHttpTransport.ts`](../../../api/registerHttpTransport.ts) | Route misses, completed/rejected/failed requests and correlation |
| Queue events | [`scheduler.ts`](../../../workflows/scheduler.ts) | Admission, wait, response, completion, overload and failures |
| Fastify configuration | [`create/app.ts`](../../../initialization/runtimes/app.ts) | Disables Fastify stdout logging |
