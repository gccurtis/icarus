...
Construction is in [`create/formula.ts`](../../../1-init/create/formula.ts) and [`startBackend.ts`](../../../1-init/startBackend.ts). The Structured Data adapter is [`create/formula-name-resolver.ts`](../../../1-init/create/formula-name-resolver.ts). The public export surface is [`index.ts`](../index.ts).
...
| Structured Data adapter | [`formula-name-resolver.ts`](../../../1-init/create/formula-name-resolver.ts) | Resolves project Structured Data declarations into a snapshot |
| Concrete endpoint consumer | [`registerStructuredDataEndpoints.ts`](../../../4-job-wiring/structured-data/registerStructuredDataEndpoints.ts) | Value lookup and ad-hoc evaluation routes |
| Durable consumer | [`documentService.ts`](../../../3-capabilities/document/application/documentService.ts) | Concurrent Formula compute and serial Rich Text settlement |
