...
The endpoint mapper is [`registerDerivedOutputEndpoints.ts`](../../../4-job-wiring/derived-outputs/registerDerivedOutputEndpoints.ts). The model call chain is in [`derived-outputs.ts`](../../../3-capabilities/derived-outputs/derived-outputs.ts).
