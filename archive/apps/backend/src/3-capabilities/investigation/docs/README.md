...
| Accepted-Finding Context resolution and scoped list/read integration | [`1-init/create/resource-reader.ts`](../../../1-init/create/resource-reader.ts) |
| HTTP decoding, job queue selection, error mapping, and endpoint logs | [`4-job-wiring/investigation/registerInvestigationEndpoints.ts`](../../../4-job-wiring/investigation/registerInvestigationEndpoints.ts) |
| Knowledge add/remove and revision-skip behavior | [`0-platform/knowledge/knowledge.ts`](../../../0-platform/knowledge/knowledge.ts) |
...
- Platform [`Knowledge`](../../../0-platform/knowledge/knowledge.ts) for accepted
  Finding ingestion and removal.
- Platform [`Logger`](../../../0-platform/observability/logger.ts) for runtime,
  endpoint, Knowledge, and startup telemetry.
- The shared job registry and scheduler for inline serial/concurrent endpoint
  execution.
- The composition-layer
  [`RuntimeResourceRegistry`](../../../1-init/create/resource-reader.ts) so an
...
- [Knowledge platform documentation](../../../0-platform/knowledge/docs/README.md)
