...
| Public endpoints | [`registerDocumentEndpoints.ts`](../../../4-job-wiring/document/registerDocumentEndpoints.ts) |
| Internal jobs | [`createDocumentJobs.ts`](../../../4-job-wiring/document/createDocumentJobs.ts), [`registerDocumentInternalJobs.ts`](../../../4-job-wiring/document/registerDocumentInternalJobs.ts) |
